document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchLatestLesson() {
    ...
    try {
      ...
      const data = await response.json()
      console.log("API DATA:", data) // 👈 Yeh daal
      quizData = data


  
      // ✅ Store and use real quiz data
      quizData = data
      updateQuizInfo(data)
      ...
      if (window.showToast) {
        window.showToast("Quiz ready! Click Start Quiz to begin.", "success")
      }
      ...
      if (window.showToast) {
        window.showToast("Error loading quiz. Please try again.", "error")
      }
  ...
  //     // For demo purposes, we'll use demo data directly
  //     useDemoData = true
  ...
  //     console.error("Error fetching quiz:", error)
  //     if (window.showToast) {
  //       window.showToast("Error loading quiz. Using demo data instead.", "warning")
  //     }
  ...
  function startQuiz() {
    ...
    if (window.showToast) {
      window.showToast("Quiz started! Good luck!", "info")
    }
  }
  ...
  function submitQuiz() {
    ...
    if (window.showToast) {
      window.showToast("Quiz completed! Check your results.", "success")
    }
  }
  ...
  function reviewAnswers() {
    ...
    playSound("message-sound")
    if (window.showToast) {
      window.showToast("Reviewing your answers", "info")
    }
  }
  ...
  function retryQuiz() {
    ...
    playSound("message-sound")
    if (window.showToast) {
      window.showToast("Quiz restarted! Good luck!", "info")
    }
  }
